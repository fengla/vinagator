            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form:form method="POST" action="/doFileUpload" enctype="multipart/form-data">

                            <%--<form:select path="type" items="${typeList}"/>--%>
                            <div class="col-lg-12" style="padding:0; margin-bottom:30px">
                                <label style="float:left">文章类型：</label>
                                <form:select path="type" class="col-lg-1">
                                    <form:options items="${typeList}"/>
                                </form:select>
                            </div>

                            <button type="submit" class="btn btn-primary pull-right" style="">提交上传</button>
