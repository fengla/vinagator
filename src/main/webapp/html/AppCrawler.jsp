...
<body>
                    ...
                    <div class="ibox-content" style="padding-bottom:80px">
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">damengxiang.me</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="srcUrl" name="srcUrl">
                                </div>
                            </div>

                            <button class="btn btn-primary" data-toggle="tooltip" data-placement="top" onclick="crawl()" style="float:right"> 提交</button>
    ...
    <script>
        ...
        function crawl(appid) {
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/crawler' ,
                type: 'GET',
                data: data,
                async: false,
                cache: false,
                ...
                success: function (resp) {
                    ...
                    console.log("修改成功,resp:"+resp.value)
                    console.log("修改成功,resp:"+resp.content)
                    console.log("修改成功,resp:"+resp.data)
                    console.log("修改成功,resp:"+resp.appName)
